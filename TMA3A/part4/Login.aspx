...
<div class="topNavBar">
        ...
        <div class="storeContainer">
            ...
            <div class="storeDisplayArea">
                ...
                <div class="passwordRecoverArea">
                    <h2>Password Recover</h2>
                    <div>
                        <asp:Label ID="pswdRecoverLabel" runat="server" Text="Email: "></asp:Label>
                        <asp:TextBox ID="pswdRecoverText" runat="server" TextMode="Email"></asp:TextBox>
                    </div>
                    <asp:Button ID="pswdRecoverButt" runat="server" Text="Password Recover" OnClick="passwordRecover_Click" causesvalidation="false" />
                </div>
