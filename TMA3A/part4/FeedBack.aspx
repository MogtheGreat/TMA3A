<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedBack.aspx.cs" Inherits="TMA3A.part4.FeedBack" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="storeContainer">
            ...
            <div class="storeDisplayArea">
                <h2>FeedBack</h2>
                <p id="FeedBackInstruct">Any problems? Suggestions? Let Us Know!</p>
                <asp:TextBox ID="FeedBackBox" Wrap="True" TextMode="MultiLine" runat="server"></asp:TextBox>
                <div>
                    <asp:Button ID="SubmitFeedBack" runat="server" Text="Submit" OnClick="SubmitFeedback_click" />
                </div>
