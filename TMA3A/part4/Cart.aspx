    ...
    <form id="form1" runat="server">
        ...
        <div class="storeContainer">
            ...
            <div class="storeDisplayArea">
                <h1>Checkout</h1>
                <asp:Label ID="OrderNumber" CssClass="OrderNumberDisplay" runat="server">Order #: </asp:Label>
                ...
                <div class="TotalCost">
                    <div id="CalculatingContainer">
                        <div class="CalculatingTotal">
                            <asp:Label ID="CartSubTotal" runat="server">SubTotal:</asp:Label>
                        </div>
                        <div class="CalculatingTotal">
                            <asp:Label ID="Tax" runat="server">Tax:</asp:Label>
                        </div>
                        <div>
                            <asp:Label ID="Total" runat="server">Total:</asp:Label>
                        </div>
                    </div>
                    <div>
